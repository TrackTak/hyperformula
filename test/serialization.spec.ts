...
describe('serialization', () => {
  ...
  it('should not loose sheet information on serialization', () => {
    ...
    expect(engine1.getCellSerialized(adr('B1')).cellValue).toEqual('2')
    ...
    expect(engine1.getCellSerialized(adr('C1')).cellValue).toEqual('foo')
    ...
    expect(engine1.getCellSerialized(adr('D1')).cellValue).toEqual(true)
    ...
    expect(engine1.getCellSerialized(adr('E1')).cellValue).toEqual('\'1')
    ...
    expect(engine1.getCellSerialized(adr('F1')).cellValue).toEqual('33$')
    ...
    expect(engine1.getCellSerialized(adr('G1')).cellValue).toEqual('12/01/15')
    ...
    expect(engine1.getCellSerialized(adr('H1')).cellValue).toEqual('1%')
    ...
    expect(engine1.getCellSerialized(adr('I1')).cellValue).toEqual('=FOO(')
    ...
    expect(engine1.getCellSerialized(adr('J1')).cellValue).toEqual('#DIV/0!')
    ...
    expect(engine1.getCellSerialized(adr('K1')).cellValue).toEqual(new Date(1995, 11, 17))
