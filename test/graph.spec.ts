...
describe('Basic Graph manipulation', () => {
  ...
  it('#topologicalSort for empty graph', () => {
    ...
    expect(graph.topSortWithScc(() => true).sorted).toEqual([])
    expect(graph.topSortWithScc(() => true).cycled).toEqual([])
  })
  ...
  it('#topologicalSort node is included even if he is not connected to anything', () => {
    ...
    expect(graph.topSortWithScc(() => true).sorted).toEqual([node])
    expect(graph.topSortWithScc(() => true).cycled).toEqual([])
  })
  ...
  it('#topologicalSort for simple graph', () => {
    ...
    expect(graph.topSortWithScc(() => true).sorted).toEqual([node1, node0])
    expect(graph.topSortWithScc(() => true).cycled).toEqual([])
  })
  ...
  it('#topologicalSort for more complex graph', () => {
    ...
    expect(graph.topSortWithScc(() => true).sorted).toEqual([node0, node1, node2, node4, node3])
    expect(graph.topSortWithScc(() => true).cycled).toEqual([])
  })
  ...
  it('#topologicalSort for not connected graph', () => {
    ...
    expect(graph.topSortWithScc(() => true).sorted).toEqual([node0, node1, node2, node3])
    expect(graph.topSortWithScc(() => true).cycled).toEqual([])
  })
  ...
  it('#topologicalSort returns vertices on trivial cycle', () => {
    ...
    expect(graph.topSortWithScc(() => true).sorted).toEqual([])
    expect(new Set(graph.topSortWithScc(() => true).cycled)).toEqual(new Set([node0, node1]))
  })
  ...
  it('#topologicalSort returns vertices on cycle', () => {
    ...
    expect(graph.topSortWithScc(() => true).sorted).toEqual([node0, node2])
    expect(graph.topSortWithScc(() => true).cycled).toEqual([node1])
  })
  ...
  it('#topologicalSort returns one-element cycle', () => {
    ...
    expect(graph.topSortWithScc(() => true).sorted).toEqual([])
    expect(graph.topSortWithScc(() => true).cycled).toEqual([node])
  })
})
