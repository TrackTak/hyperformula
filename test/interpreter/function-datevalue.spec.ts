...
describe('Function DATEVALUE', () => {
  it('with wrong arguments', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: '=DATEVALUE("foo")' }, { cellValue: '=DATEVALUE(1)' }, { cellValue: '=DATEVALUE(1, 2)' }, { cellValue: '=DATEVALUE()'}]])
  ...
  it('with string arguments', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: '=DATEVALUE("31/12/1899")' }, { cellValue: '=DATEVALUE("01/01/1900")' }, { cellValue: '=DATEVALUE("31/12/2018")' }]])
  ...
  it('ignores time', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: '=DATEVALUE("2:00pm")' }, { cellValue: '=DATEVALUE("31/12/2018 2:00pm")' }]])
  ...
  it('border case', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: '=DATEVALUE("25:00")' }, { cellValue: '=DATEVALUE("31/12/2018 25:00")' }]])
