...
describe('Function EDATE', () => {
  it('validate arguments', () => {
    const [engine] = HyperFormula.buildFromArray({ cells: [
      ...
      [{ cellValue: '=EDATE("foo", 0)' }],
      [{ cellValue: '=EDATE(A1, "bar")' }],
      [{ cellValue: '=EDATE(A1)' }],
      [{ cellValue: '=EDATE(A1, "bar", "baz")' }],
    ]})
  ...
  it('use number coercion for 2nd argument', () => {
    const [engine] = HyperFormula.buildFromArray({ cells: [
      [{ cellValue: '=DATE(2019, 3, 31)' }],
      [{ cellValue: '="1"' }, { cellValue: '=EDATE(A1, A2)' }],
      [{ cellValue: '=TRUE()' }, { cellValue: '=EDATE(A1, A3)' }],
    ]})
  ...
  it('propagate errors', () => {
    const [engine] = HyperFormula.buildFromArray({ cells: [
      [{ cellValue: '=EDATE(4/0, 0)' }],
      [{ cellValue: '=EDATE(0, 4/0)' }],
      [{ cellValue: '=EDATE(4/0, FOOBAR())' }],
    ]})
