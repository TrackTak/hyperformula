...
describe('Interpreter - function ARRAY_CONSTRAIN', () => {
  ...
  it('works #3', () => {
    ...
    expect(engine.getSheetValues(0).cells).toEqual([[{ cellValue: 1 }, { cellValue: 2 }], [{ cellValue: 4 }, { cellValue: 5 }]])
  })
  ...
  it('works #4', () => {
    ...
    expect(engine.getSheetValues(0).cells).toEqual([[{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }], [{ cellValue: 4 }, { cellValue: 5 }, { cellValue: 6 }]])
  })
