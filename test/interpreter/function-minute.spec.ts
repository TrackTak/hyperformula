...
describe('Function MINUTE', () => {
  it('with wrong arguments', () => {
    const [engine] = HyperFormula.buildFromArray({ cells: [[{ cellValue: '=MINUTE("foo")' }, { cellValue: '=MINUTE("12/30/2018")' }, { cellValue: '=MINUTE(1, 2)' }, { cellValue: '=MINUTE()'}]]})
  ...
  it('with numerical arguments', () => {
    const [engine] = HyperFormula.buildFromArray({ cells: [[{ cellValue: '=MINUTE(0.5123456)' }, { cellValue: '=MINUTE(0)' }, { cellValue: '=MINUTE(0.999999)' }]]})
  ...
  it('with string arguments', () => {
    const [engine] = HyperFormula.buildFromArray({ cells: [[{ cellValue: '=MINUTE("14:42:59")' }, { cellValue: '=MINUTE("01/01/1900 03:01:02am")' }, { cellValue: '=MINUTE("31/12/2018")' }]]})
