...
describe('Function ASIN', () => {
  it('happy path', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: '=ASIN(0)' }, { cellValue: '=ASIN(0.5)' }]])
  ...
  it('when value not numeric', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: '=ASIN("foo")' }]])

    expect(engine.getCellValue(adr('A1'))).toEqualError(detailedError(ErrorType.VALUE, ErrorMessage.NumberCoercion))
  })

  it('for 1 (edge)', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: '=ASIN(1)' }]], {smartRounding: false})
  ...
  it('when value too large', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: '=ASIN(1.1)' }]])
  ...
  it('wrong number of arguments', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: '=ASIN()' }, { cellValue: '=ASIN(1,-1)' }]])
