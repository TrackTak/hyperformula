...
describe('swapping rows - checking if it is possible', () => {
  ...
  it('should validate sources for noninteger values', () => {
    const [engine] = HyperFormula.buildFromArray([[]])
    expect(engine.isItPossibleToSwapRowIndexes(0, [[{ cellValue: 1 }, { cellValue: 1 }], [0.5, 0]])).toEqual(false)
    expect(() =>
      engine.swapRowIndexes(0, [[{ cellValue: 1 }, { cellValue: 1 }], [0.5, 0]])
    ).toThrowError('Invalid arguments, expected row numbers to be nonnegative integers and less than sheet height.')
  })
  ...
  it('should validate sources for values exceeding sheet height', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[{ cellValue: 1 }, { cellValue: 1 }], [{ cellValue: 1 }, { cellValue: 1 }]])).toEqual(false)
    expect(() =>
      engine.swapRowIndexes(0, [[{ cellValue: 3 }, { cellValue: 0 }]])
    ).toThrowError('Invalid arguments, expected row numbers to be nonnegative integers and less than sheet height.')
  })

  it('should validate sources to be unique', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 0 }], [{ cellValue: 0 }], [{ cellValue: 0 }]])
    expect(engine.isItPossibleToSwapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 0 }], [{ cellValue: 0 }, { cellValue: 0 }], [{ cellValue: 0 }, { cellValue: 0 }]])).toEqual(false)
    expect(() =>
      engine.swapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 0 }], [{ cellValue: 0 }, { cellValue: 0 }], [{ cellValue: 0 }, { cellValue: 0 }]])
  ...
  it('should check for matrices', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 0 }], [{ cellValue: 0 }], [{ cellValue: 0 }]])
    expect(engine.isItPossibleToSwapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 2 }], [{ cellValue: 0 }, { cellValue: 2 }], [{ cellValue: 0 }, { cellValue: 2 }]])).toEqual(false)
    expect(() =>
      engine.swapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 2 }], [{ cellValue: 0 }, { cellValue: 2 }], [{ cellValue: 0 }, { cellValue: 2 }]])
  ...
  it('should check for matrices only in moved rows', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 0 }], [{ cellValue: 0 }], [{ cellValue: 0 }]])
    expect(engine.isItPossibleToSwapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 1 }], [{ cellValue: 0 }, { cellValue: 1 }], [{ cellValue: 0 }, { cellValue: 1 }]])).toEqual(true)
    expect(() =>
      engine.swapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 1 }], [{ cellValue: 0 }, { cellValue: 1 }], [{ cellValue: 0 }, { cellValue: 1 }]])
    ).not.toThrowError()
  })
})
...
describe('swapping rows should correctly work', () => {
  it('should work on static engine', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 1 }], [{ cellValue: 0 }, { cellValue: 1 }]])).toEqual(true)
    engine.swapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 1 }], [{ cellValue: 0 }, { cellValue: 1 }]])
  ...
  it('should return number of changed cells', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 1 }], [{ cellValue: 0 }, { cellValue: 1 }]])).toEqual(true)
    const [ret] = engine.swapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 1 }], [{ cellValue: 0 }, { cellValue: 1 }]])
  ...
  it('should not move values unnecessarily', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }], [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }]])
    expect(engine.isItPossibleToSwapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 0 }], [{ cellValue: 0 }, { cellValue: 0 }]])).toEqual(true)
    const [ret] = engine.swapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 0 }], [{ cellValue: 0 }, { cellValue: 0 }]])
...
describe('swapping rows working with redo', () => {
  ...
  it('clears redo stack', () => {
    ...
    engine.swapRowIndexes(0, [[{ cellValue: 0 }, { cellValue: 0 }]])
...
describe('setting row order - checking if it is possible', () => {
  it('should check for length', () => {
    const [engine] = HyperFormula.buildFromArray([[]])
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 0 }])).toEqual(false)
    expect(() =>
      engine.setRowOrder(0, [{ cellValue: 0 }])
  ...
  it('should validate for repeated values', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 0 }], [{ cellValue: 0 }], [{ cellValue: 0 }]])
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 0 }, { cellValue: 1 }, { cellValue: 1 }])).toEqual(false)
    expect(() =>
      engine.setRowOrder(0, [{ cellValue: 0 }, { cellValue: 1 }, { cellValue: 1 }])
    ).toThrowError('Invalid arguments, expected target row numbers to be permutation of source row numbers.')
  })

  it('should validate sources to be permutation of targets', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 0 }], [{ cellValue: 0 }], [{ cellValue: 0 }]])
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }])).toEqual(false)
    expect(() =>
      engine.setRowOrder(0, [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }])
    ).toThrowError('Invalid arguments, expected target row numbers to be permutation of source row numbers.')
  })

  it('should check for matrices', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 0 }], [{ cellValue: 0 }], [{ cellValue: 0 }]])
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 2 }, { cellValue: 1 }, { cellValue: 0 }])).toEqual(false)
    expect(() =>
      engine.setRowOrder(0, [{ cellValue: 2 }, { cellValue: 1 }, { cellValue: 0 }])
    ).toThrowError('Cannot perform this operation, source location has an array inside.')
  })

  it('should check for matrices only in moved rows', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 0 }], [{ cellValue: 0 }], [{ cellValue: 0 }]])
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 1 }, { cellValue: 0 }, { cellValue: 2 }])).toEqual(true)
    expect(() =>
      engine.setRowOrder(0, [{ cellValue: 1 }, { cellValue: 0 }, { cellValue: 2 }])
    ).not.toThrowError()
  })
})
...
describe('reorder base case', () => {
  it('should work on static engine', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 1 }, { cellValue: 'abcd' }, { cellValue: 3 }], [{ cellValue: 1 }, { cellValue: 'abcd' }, { cellValue: 3 }]])
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 1 }, { cellValue: 0 }])).toEqual(true)
    engine.setRowOrder(0, [{ cellValue: 1 }, { cellValue: 0 }])
    expect(engine.getSheetSerialized(0)).toEqual([[{ cellValue: 3 }, { cellValue: 5 }, { cellValue: true }], [{ cellValue: 3 }, { cellValue: 5 }, { cellValue: true }]])
  })
  ...
  it('should return number of changed cells', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }], [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }]])
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 1 }, { cellValue: 0 }])).toEqual(true)
    const [ret] = engine.setRowOrder(0, [{ cellValue: 1 }, { cellValue: 0 }])
    expect(ret.length).toEqual(6)
  })
  ...
  it('should work with more complicated permutations', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }], [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }], [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }]])
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 0 }])).toEqual(true)
    engine.setRowOrder(0, [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 0 }])
    expect(engine.getSheetSerialized(0)).toEqual([[{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }]])
  })

  it('should not move values unnecessarily', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }], [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }]])
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 0 }, { cellValue: 1 }])).toEqual(true)
    const [ret] = engine.setRowOrder(0, [{ cellValue: 0 }, { cellValue: 1 }])
    expect(ret.length).toEqual(0)
  })

  it('should work with external references', () => {
    const [engine] = HyperFormula.buildFromArray([[{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }], [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }], [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 3 }], [{ cellValue: '=A1' }, { cellValue: '=SUM(A2:A3)' }]])
    engine.setRowOrder(0, [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 0 }, { cellValue: 3}])
    expect(engine.getSheetSerialized(0)).toEqual([[{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: '=A1' }, { cellValue: '=SUM(A2:A3)' }]])
    expect(engine.getSheetValues(0)).toEqual([[{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 5 }]])
  })
...
describe('reorder working with redo', () => {
  ...
  it('should work with external references', () => {
    ...
    engine.setRowOrder(0, [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 0 }, { cellValue: 3}])
    engine.undo()
    expect(engine.isItPossibleToSetRowOrder(0, [{ cellValue: 1 }, { cellValue: 2 }, { cellValue: 0 }, { cellValue: 3}])).toEqual(true)
    engine.redo()
    expect(engine.getSheetSerialized(0)).toEqual([[{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: '=A1' }, { cellValue: '=SUM(A2:A3)' }]])
    expect(engine.getSheetValues(0)).toEqual([[{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 8 }, { cellValue: 9 }], [{ cellValue: 7 }, { cellValue: 5 }]])
  })
